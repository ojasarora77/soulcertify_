...
interface HorizontalOrbEffectProps {
  height?: string;
  hue?: number;
  forceHoverState?: boolean;
}

export default function HorizontalOrbEffect({
  height = "8px",
  hue = 20,
  forceHoverState = true,
}: HorizontalOrbEffectProps) {
  ...
  return <div ref={ctnDom} style={{ width: '100%', height, overflow: 'hidden' }} />;
}
